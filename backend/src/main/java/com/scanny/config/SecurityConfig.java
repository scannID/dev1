    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/auth/staff/**").hasRole("STAFF")
                .requestMatchers("/api/businesses/*/operations/kitchen/**").permitAll()
                .requestMatchers("/api/businesses/*/operations/tables/**").permitAll()
                .requestMatchers("/api/businesses/*/operations/table-sessions/**").permitAll()
                .requestMatchers("/api/businesses/*/operations/orders/**").permitAll()
                ...
                .requestMatchers("/api/businesses/**").hasAnyRole("MERCHANT", "STAFF_MANAGER", "STAFF")
                .requestMatchers("/api/catalog/**").hasAnyRole("MERCHANT", "STAFF_MANAGER", "STAFF")
                .requestMatchers("/api/orders/**").hasAnyRole("MERCHANT", "ADMIN", "STAFF_MANAGER", "STAFF")
                .requestMatchers("/api/receipts/**").hasAnyRole("MERCHANT", "ADMIN", "STAFF_MANAGER", "STAFF")
