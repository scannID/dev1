...
/** Animated dancing figure for merchant portal boot (replaces the book loader). */
...
/** @deprecated Use DanceLoader — kept so old imports keep working. */
export function BookLoader(props: DanceLoaderProps) {
  return <DanceLoader {...props} />
}
