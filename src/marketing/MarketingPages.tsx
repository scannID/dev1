...
export const marketingPages: Record<MarketingSlug, MarketingPage> = {
    ...
    body: (
      <>
        <SimpleTable
          ...
          rows={[
            ['Starter', 'Trying Koddly with one location', 'QR ordering, catalog, live dashboard, core payment tracking'],
  ...
  about: {
    eyebrow: 'Company',
    title: 'About Koddly',
    lead: 'Koddly helps modern venues turn menus into scannable ordering experiences — so customers move faster and teams stay in control.',
    showCta: true,
    body: (
      <>
  ...
  careers: {
    ...
    body: (
      <>
        ...
        <Section title="Apply">
          Send a short note and CV to <strong style={{ color: 'var(--foreground)' }}>careers@koddly.com</strong>. Tell us what you want to build and why Koddly.
        </Section>
      </>
    ),
  },
    ...
    body: (
      <>
        <Section title="Channels">
          <Bullets
            items={[
              'General: hello@koddly.com',
              'Support: support@koddly.com',
              'Press: press@koddly.com',
            ]}
          />
        </Section>
    ...
    body: (
      <>
        <Section title="About the company">
          Koddly is a QR ordering platform for merchants. Customers scan, browse a live catalog, and place orders; merchants manage fulfillment from a real-time dashboard.
        </Section>
        <Section title="Boilerplate">
          Koddly turns menus and catalogs into scannable ordering experiences. Built for restaurants, hotels, cafés, and service businesses that need speed without forcing guests to install an app.
        </Section>
        <Section title="Media contact">
          For interviews, logos, or product briefings: <strong style={{ color: 'var(--foreground)' }}>press@koddly.com</strong>
        </Section>
      </>
    ),
  },
  ...
  help: {
    eyebrow: 'Resources',
    title: 'Help center',
    lead: 'Answers to the questions merchants ask most when going live with Koddly.',
    showCta: true,
    body: (
      <>
        ...
        <Section title="Still stuck?">
          Email <strong style={{ color: 'var(--foreground)' }}>support@koddly.com</strong> with your business name and a short description of the issue.
        </Section>
      </>
    ),
  },
    ...
    body: (
      <>
        ...
        <Section title="More coming">
          We publish new guides as merchant patterns emerge. Request a topic via support@koddly.com.
        </Section>
      </>
    ),
  },
  ...
  status: {
    eyebrow: 'Resources',
    title: 'System status',
    lead: 'Current availability of Koddly services. We aim for transparent, timely updates.',
    showCta: false,
    body: (
      <>
        <div
    ...
    body: (
      <>
        <Section title="Overview">
          Koddly exposes authenticated HTTP APIs for catalog, orders, and business configuration used by the merchant and customer applications.
        </Section>
        <SimpleTable
        ...
        <Section title="Access">
          API access for production integrations is granted per account. Contact <strong style={{ color: 'var(--foreground)' }}>hello@koddly.com</strong> with your use case.
        </Section>
      </>
    ),
  },
  ...
  privacy: {
    ...
    lead: `Last updated ${LEGAL_UPDATED}. This policy explains how Koddly collects, uses, and protects information.`,
    narrow: true,
    showCta: false,
    body: (
      <>
        <Section title="Who we are">
          Koddly provides QR ordering software for merchants and ordering experiences for their customers. For privacy questions, contact privacy@koddly.com.
        </Section>
        ...
        <Section title="Your choices">
          Merchants may update account information in-product. For access or deletion requests, email privacy@koddly.com. We will respond within a reasonable period.
        </Section>
      </>
    ),
  },
  ...
  terms: {
    ...
    lead: `Last updated ${LEGAL_UPDATED}. By using Koddly you agree to these terms.`,
    narrow: true,
    showCta: false,
    body: (
      <>
        <Section title="The service">
          Koddly provides software for QR-based ordering, catalog management, and merchant order operations. Features may evolve; we will aim to avoid material disruption where practical.
        </Section>
        ...
        <Section title="Acceptable use">
          You may not misuse the service, attempt unauthorized access, interfere with other customers, or use Koddly for unlawful activity.
        </Section>
        <Section title="Your content">
          You retain rights to catalogs and business content you upload. You grant Koddly a limited license to host and process that content solely to operate the product.
        </Section>
        ...
        <Section title="Contact">
          Questions about these terms: legal@koddly.com.
        </Section>
      </>
    ),
  },
    ...
    body: (
      <>
        ...
        <Section title="Report a vulnerability">
          Email security@koddly.com with enough detail to reproduce the issue. Please avoid public disclosure until we have had a reasonable chance to respond.
        </Section>
      </>
    ),
  },
  ...
  cookies: {
    eyebrow: 'Legal',
    title: 'Cookie Policy',
    lead: `Last updated ${LEGAL_UPDATED}. This page describes how Koddly uses cookies and similar technologies.`,
    narrow: true,
    showCta: false,
    body: (
      <>
